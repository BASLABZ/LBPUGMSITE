            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-primary" style="border-color: white;">
                        <div class="panel-heading">
                            <span class=""></span> Data Pengembalian Alat
                        </div>
                                                ...
                                                <?php 
                                                 ...
                                                 ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="#detail_pengamnilan_alat" data-toggle='modal' data-id='<?php echo $ropengembalian_alat['loan_invoice']; ?>' class="btn btn-info dim_about"> <span class=""></span> Detail Pengembalian</a>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #1ab394; color:white;">
                    ...
                    <h4 class="modal-title"><span class=""></span> Detail Pengembalian</h4>
                </div>
