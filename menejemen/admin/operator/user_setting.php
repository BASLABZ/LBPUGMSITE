<?php 
        ...
        $queryupdate  = mysql_query("UPDATE ref_operator set 
                                                    ...
                                                    operator_username = '".$_POST['operator_username']."', operator_hint_question = '".$_POST['operator_hint_question']."',
        ...
        if (isset($_POST['updatepassword'])) {
            $querypassword = mysql_query("UPDATE ref_operator set operator_password = md5('".$_POST['operator_password']."') where operator_id='".$id."'");
            if ($querypassword) {
                echo "<script> alert('Password Berhasil Diubah'); location.href='index.php?hal=operator/user_setting&id=".$id."' </script>";exit;;
            } else {
                echo "<script> alert('Password Gagal Diubah'); location.href='index.php?hal=operator/operator/user_setting&id=".$id."' </script>";exit;
            }
        }
 ?>
								    ...
								    <div class="row">
								    	<div class="col-md-12">
								    		...
								    		<div class="form-group row">
								    			...
								    			<div class="col-md-6">
								    				<input type="password" class="form-control" name="operator_password"> 
								    			</div>
								    		</div>
								    		<div class="form-group row">
								    		<div class="col-md-8">
								    			<button type="submit" name="updatepassword" class="btn btn-sm btn-success dim_about pull-right" > <span class="fa fa-save"></span> Simpan</button>
								    		</div>
								    		</div>
