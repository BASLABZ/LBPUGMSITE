<?php 
		...
		$rowPenagihan = mysql_fetch_array(mysql_query("SELECT * FROM trx_payment a join tbl_member m ON a.member_id_fk = m.member_id join trx_loan_application p ON p.loan_app_id = a.loan_app_id_fk where p.loan_invoice = '".$invoice."' AND a.payment_category = 'PEMBAYARAN DENDA' "));
