                            ...
                            <table class="table table-striped table-bordered table-hover"  id="dataTables-example">
                                                ...
                                                <?php 
                                                    ...
                                                    $queryPembayaran = 
                                                        ...
                                                        WHERE p.payment_category = 'PEMBAYARAN DENDA'
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="#detail_peminjaman_yangdibayar_denda" data-toggle='modal' data-id='<?php echo $roWPembayaran['loan_invoice']; ?>' class="btn btn-info dim_about"> <span class="fa fa-eye"></span> LIHAT DATA</a></td> 
                                                    </tr>
                                                 <?php } ?>
                                                </tbody>
                                            </table>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function(){
        $('#detail_peminjaman_yangdibayar_denda').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type : 'post',
                url : 'pembayaran/slipPenagihan_denda.php',
                data :  'id='+ rowid,
                success : function(data){
